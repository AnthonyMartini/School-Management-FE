...
const StudentsPage: React.FC = () => {
  ...
  // Convert filtered students to string values for DataTable
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      render: (value: unknown) => {
        const attendance = parseFloat(String(value));
        return (
          <span
            className={`font-medium ${
              attendance >= 95
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="bg-linear-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-blue-600 hover:to-purple-700 transition-colors flex items-center space-x-2">
          <Plus size={20} />
